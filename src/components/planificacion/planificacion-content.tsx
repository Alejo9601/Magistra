...
import { ClassEditorModal } from "@/components/planificacion/class-editor-modal";
import { ClassScheduleModal } from "@/components/planificacion/class-schedule-modal";
import {
   classTypeColors,
   classTypeLabels,
   getStatusColor,
   getStatusLabel,
   monthNames,
} from "@/components/planificacion/constants";
import type {
   ClassFormInput,
   StatusFilter,
   TypeFilter,
   ViewMode,
} from "@/components/planificacion/types";
